...
def main():
    ...
    env_name = 'oscillator'
    render = False
    solved_reward = 1.2         # stop training if avg_reward > solved_reward
    log_interval = 20           # print avg reward in the interval
    max_episodes = 6000        # max training episodes
    ...
    for i_episode in range(1, max_episodes+1):
        ...
        if i_episode == max_episodes:
            print("########## Solved! ##########")
            x_axis = [x for x in range(len(env.his_b))]
            plt.plot(x_axis, env.his_b)
            plt.xlabel('t')
            plt.ylabel('b')
            plt.show()
            ...
            # b_data = pd.DataFrame(columns=None, data=env.his_b)
            # b_data.to_excel('C:/Users/shangyan/Desktop/PPO/b_data.xlsx')
            # a1_data = pd.DataFrame(columns=None, data=env.his_a1)
            # a1_data.to_excel('C:/Users/shangyan/Desktop/PPO/a1_data.xlsx')
            # a2_data = pd.DataFrame(columns=None, data=env.his_a2)
            # a2_data.to_excel('C:/Users/shangyan/Desktop/PPO/a2_data.xlsx')
            break
